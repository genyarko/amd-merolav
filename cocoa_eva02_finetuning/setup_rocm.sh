#!/usr/bin/env bash
# Cocoa EVA-02 — environment setup on the DigitalOcean "PyTorch 2.6.0 + ROCm 7.0" image.
#
...
echo "Next: stage the dataset (see stage_cocoa_dataset.sh), then run run_mi300x.sh."
