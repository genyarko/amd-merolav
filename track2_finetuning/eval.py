"""Evaluate a trained DINOv2-L checkpoint with standard + TTA scoring.
...
def tta_tf(cfg):
    ...
    return create_transform(
        ...
        auto_augment=None, re_prob=0.0, hflip=0.5, vflip=0.0,
        mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225),
...
def main():
    ...
    # Standard
    ds_std = CCMTDataset(splits["test"], clean_tf(cfg))
    ...
    for r in range(args.tta - 1):
        ...
        ds = CCMTDataset(splits["test"], tta_tf(cfg))
    ...
    (out_dir / "metrics.json").write_text(json.dumps({
        ...
        "baseline_p100_effnetb0_acc": 0.9316,
        "baseline_p100_effnetb0_macro_f1": 0.9348,
    }, indent=2))
