#!/usr/bin/env bash
# Cocoa Amini — environment setup on the DigitalOcean "PyTorch 2.6.0 + ROCm 7.0" image.
#
...
echo "Next: stage the dataset (see stage_amini_dataset.sh), then run run_mi300x.sh."
